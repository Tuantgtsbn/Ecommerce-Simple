...
function DashboardPage() {
  ...
  const {isLoading: isLoadingOrders, statisticsOrders: objStatisticsOrders} =
    useSelector((state) => state.adminOrders);
  const {
    isLoading: isLoadingProducts,
    statisticsProducts: objStatisticsProducts,
  } = useSelector((state) => state.adminProducts);
  const {isLoading: isLoadingUsers, statisticsUsers: objStatisticsUsers} =
  ...
  useEffect(() => {
    window.document.title = "Bảng điều khiển - Admin";
  }, []);
  const orderStatusData = useMemo(() => {
    let [countPending, countInProcess, countCancelled, countDelivered] = [
      0, 0, 0, 0,
    ];
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                +{objStatisticsOrders?.statistics?.growth.orders || 0}% from
                last month
              </p>
            </CardContent>
          </Card>
        ...
        {isLoadingProducts ? (
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                +{objStatisticsProducts?.newProducts || 0} new products from
                last month
              </p>
            </CardContent>
          </Card>
