...
import { deleteCartItem, fetchCartItems, updateCartItemQty } from '@/store/shop/cart-slice';
...
function CartItem({ item }) {
    ...
    const handleChangeQuantity = async (type) => {
        ...
        try {
            ...
            await dispatch(
                updateCartItemQty({ userId: user.id, productId: item.productId, quantity })
            ).unwrap();
    ...
    const handleDeleteItem = async () => {
        try {
            await dispatch(deleteCartItem({ userId: user.id, productId: item.productId })).unwrap();
