...
export const updateProfile = createAsyncThunk(
    ...
    async (profileData, { rejectWithValue }) => {
        try {
            const response = await axiosClient.put('/api/auth/update-profile', profileData, {
                withCredentials: true
            });
            return response.data;
        } catch (error) {
...
const asyncThunks = [registerUser, loginUser, logoutUser, checkAuth, updateProfile, changePassword];
