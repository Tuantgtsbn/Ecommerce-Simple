...
const CheckoutShoppingPage = lazy(
  () => import("@/pages/shopping-view/checkout"),
);
const PayPalReturnPage = lazy(
  () => import("@/pages/shopping-view/paypal-return"),
);
const PayPalCancelPage = lazy(
  () => import("@/pages/shopping-view/paypal-cancel"),
);
...
const PostByCategoryPage = lazy(
  () => import("@/pages/shopping-view/postByCategory"),
);
function App() {
